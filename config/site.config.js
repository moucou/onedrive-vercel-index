...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'one@mail.fourfortyfour.xyz',
  ...
  protectedRoutes: ['/Private', '/OneSyncFiles'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:moucou@qq.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/moucou/onedrive-vercel-inde',
    },
    {
      name: 'Twitter',
